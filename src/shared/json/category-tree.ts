export const CategoryTree = {
    ...
    category: [
        ...
        //         },
        //         {
        //             name: 'Diapers & Wipes', slug: 'diapers-&-wipes', image_urls: ['assets/dummy/baby-care/diapers-&-wipes.jpg'],
        //             sub_sub_category: [
        ...
        //         },
        //         {
        //             name: 'Fooding', slug: 'fooding', image_urls: ['assets/dummy/baby-care/fooding.jpg'],
        //             sub_sub_category: [
        ...
        //     sub_category: [
        //         {
        //             name: 'Fruits & Vegetables', slug: 'fruits-&-vegetables', image_urls: ['assets/dummy/photos/electronics/7.jpg'],
        //             sub_sub_category: [
        ...
        //         },
        //         {
        //             name: 'Breakfast', slug: 'breakfast', image_urls: ['assets/dummy/photos/homeware/1.jpg'],
        //             sub_sub_category: [
        ...
        //         },
        //         {
        //             name: 'Beverages', slug: 'beverages', image_urls: ['assets/dummy/food/beverages.jpg'],
        //             sub_sub_category: [
        ...
        //         },
        //         {
        //             name: 'Meat & Fish', slug: 'meat-&-fish', image_urls: ['assets/dummy/food/meat-&-fish.jpg'],
        //             sub_sub_category: [
        ...
        //         },
        //         {
        //             name: 'Cooking', slug: 'cooking', image_urls: ['assets/dummy/food/cooking.jpg'],
        //             sub_sub_category: [
        //                 { name: 'Rice', slug: 'rice', image_urls: ['assets/dummy/food/rice.jpg'] },
        //                 { name: 'Spices', slug: 'spices', image_urls: ['assets/dummy/food/spices.jpg'] },
        //                 { name: 'Ghee', slug: 'ghee', image_urls: ['assets/dummy/food/ghee.jpg'] },
        //                 { name: 'Oil', slug: 'oil', image_urls: ['assets/dummy/food/oil.jpg'] },
        //             ]
        //         },
        ...
        //     image_urls: ['assets/dummy/office-products/office-products.jpg'],
        //     sub_category: [
        //         {
        //             name: 'Batteries', slug: 'batteries', image_urls: ['assets/dummy/office-products/batteries.jpg'], sub_sub_category: []
        //         },
        //         {
        //             name: 'Writing & Drawing', slug: 'writing-&-drawing', image_urls: ['assets/dummy/office-products/writing-&-drawing.jpg'],
        //             sub_sub_category: [
        //                 { name: 'Colours', slug: 'colours', image_urls: ['assets/dummy/office-products/colours.jpg'] },
        //                 { name: 'Pens', slug: 'pens', image_urls: ['assets/dummy/office-products/pens.jpg'] },
        //             ]
        //         },
        //     ],
        // },
        {
            name: 'Honey',
            slug: 'honey',
            image_urls: ['assets/images/category/honey.jpg'],
            sub_category: [
                // {
                //     name: 'Batteries', slug: 'batteries', image_urls: ['assets/dummy/office-products/batteries.jpg'], sub_sub_category: []
                // },
        ...
        },
        {
            name: 'Spices',
            slug: 'spices',
            image_urls: ['assets/images/category/spices.jpg'],
            sub_category: [],
        },
        {
            name: 'Sugar',
            slug: 'sugar',
            image_urls: ['assets/images/category/suger.jpg'],
            sub_category: [],
        },
        {
            name: 'Dal',
            slug: 'dal',
            image_urls: ['assets/images/category/dal.jpg'],
            sub_category: [],
        },
        {
            name: 'Tea',
            slug: 'tea',
            image_urls: ['assets/images/category/tea.jpg'],
            sub_category: [],
        },
        {
            name: 'Ghee',
            slug: 'ghee',
            image_urls: ['assets/images/category/ghee.jpg'],
            sub_category: [],
        },
        {
            name: 'Chira',
